...
takephotoBaseConfig = [
    ...
    ['拍视频页，贴纸：星空妆，打开面板',
     "m2u://m2u_home/sticker?materialId=11653675879495264054\'&\'catId=10\'&\'openSticker=1\'&\'jumpStrategy=1"],
    ['拍照页，音乐：甜蜜暴击，MV：黑白格，打开面板',
     "m2u://m2u_home/mv?mvMaterialId=4592210740139934656\'&\'openMVBoard=1\'&\'musicId=13849353500971794162\'&\'jumpStrategy=0"],
    ...
    ['贴图+非hot的tab',
     '{\\"from\\":\\"yitianH5\\",\\"data\\":{\\"jumpUrl\\":\\"m2u://materialcenter?func=pe_chartlet\'&\'catId=14203952946683646248\\"}}'],
    ['贴图+hot的tab+素材',
     '{\\"from\\":\\"yitianH5\\",\\"data\\":{\\"jumpUrl\\":\\"m2u://materialcenter?func=pe_chartlet\'&\'catId=1001\'&\'materialId=11490196417641268516\\"}}'],
    ['贴图+非hot的tab+素材',
     "m2u://materialcenter?func=pe_chartlet\'&\'catId=12924239871261681147\'&\'materialId=1a14c76795051a89d3e7a337a1d8d096"],
    ...
    ["一键get-图片-分类：天空便利店", "m2u://template?catId=207"],
...
editphotoBaseConfig = [
    ...
    ['风格-铃木-滤镜-50',
     "m2u://photo_edit?func=pe_style\'&\'materialId=10383854300615203545\'&\'catId=95\'&\'filterValue=50\'&\'makeupValue=100"],
    ...
    ['贴图-蕉个朋友',
     "m2u://photo_edit?func=pe_chartlet\'&\'catId=2850425357754097742\'&\'materialId=e8256d5be4d1e6af7c5f353f7539488a"],
    ['涂鸦笔-桃子爱心', "m2u://photo_edit?func=pe_graffiti\'&\'materialId=1584548826550941119"],
    ['贴纸-质感-星空-30',
     "m2u://photo_edit?func=pe_sticker\'&\'materialId=15735563591719004765\'&\'catId=20\'&\'makeupValue=30"],
    ['文字贴纸',
